...
public class CustomerIT extends RestfulIT {
	...
	public void setup() throws Exception {
		...
		HttpResponse response = this.doPost("admin", "/restlet/v2_1/Customer", barMap);
	...
	public void shouldAllowGetACustomer() throws Exception {
		...
		HttpResponse response = this.doGet("admin", "/restlet/v2_1/Customer/" + barId, null);
		assertEquals(200, response.getStatusCode());
	...
	public void shouldAllowUpdateACustomer() throws Exception {
		...
		HttpResponse response = this.doPut("admin", "/restlet/v2_1/Customer/" + barId, newBarMap);
		assertEquals(200, response.getStatusCode());
		
		// Then: check the name has updated
		response = this.doGet("admin", "/restlet/v2_1/Customer/" + barId, null);
		assertEquals(200, response.getStatusCode());
	...
	public void shouldAllowDeleteACustomer() throws Exception {
		...
		HttpResponse response = this.doDelete("admin", "/restlet/v2_1/Customer/" + barId, null);
