...
public class CustomerIT extends RestfulIT {
	...
	public void setup() throws Exception {
		...
		HttpResponse response = this.doPost("isvtest", "/restlet/v2_1/Customer", barMap);
	...
	public void shouldAllowGetACustomer() throws Exception {
		...
		HttpResponse response = this.doGet("isvtest", "/restlet/v2_1/Customer/" + barId, null);
		assertEquals(200, response.getStatusCode());
	...
	public void shouldAllowUpdateACustomer() throws Exception {
		...
		HttpResponse response = this.doPut("isvtest", "/restlet/v2_1/Customer/" + barId, newBarMap);
		assertEquals(200, response.getStatusCode());
		
		// Then: check the name has updated
		response = this.doGet("isvtest", "/restlet/v2_1/Customer/" + barId, null);
		assertEquals(200, response.getStatusCode());
	...
	public void shouldAllowDeleteACustomer() throws Exception {
		...
		HttpResponse response = this.doDelete("isvtest", "/restlet/v2_1/Customer/" + barId, null);
	...
	public void shouldAllowAddANewCustomerWithAContact() throws Exception {
		...
		HttpResponse response = this.doPost("isvtest", "/restlet/v2_1/Customer/WithContact", barWithFooMap);
		assertEquals(200, response.getStatusCode());		
